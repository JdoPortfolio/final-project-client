...
const HomePage = () => {
  ...
  // useEffect(() => {
  //   // This assumes you've added a `refreshDealerships` method to your context
  //   refreshDealerships();
  // }, [refreshDealerships]);
    ...
    <div>
      ...
      <section id="home-banner" className="home-banner">
        <Container className="text-center" >
          <h1 class="display-1 banner-title">
            Bridging Dreams Across Languages: Your Car, Su Vehículo
          </h1>
          <p className="banner-subtitle" class="display-2 text-muted text-light">
      ...
      <section id="join-us" className="join-us">
        <Container className="text-center">
          <h2>Join KonduceAuto Today</h2>
          <h3>Your gateway to the Hispanic market awaits!</h3>
          <p>
