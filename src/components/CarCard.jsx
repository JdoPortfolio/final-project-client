...
const CarCard = ({ car, onUpdate, onDelete, canModify = false }) => {
  return (
    <div className="card mb-3 d-flex flex-row" style={{ maxWidth: "540px" }}>
      ...
      <div className="col-md-8 d-flex flex-column justify-content-between"> {/* Adjusted for vertical alignment */}
        <div>
        ...
        {/* Button container adjusted for alignment to the bottom-right */}
        {canModify && (
